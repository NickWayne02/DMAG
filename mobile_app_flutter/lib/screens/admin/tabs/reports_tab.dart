...
class _ReportsTabState extends State<ReportsTab> {
  ...
  Widget build(BuildContext context) {
    final List<String> sites = [context.watch<LocaleProvider>().t('dashboard.all_sites') ?? 'Все объекты', 'Bellershausen', 'Светловодск', 'Giengen', 'Freudenberg'];
    final List<String> times = [context.watch<LocaleProvider>().t('dashboard.time_all') ?? 'За всё время', context.watch<LocaleProvider>().t('dashboard.time_today') ?? 'За сегодня', context.watch<LocaleProvider>().t('dashboard.time_week') ?? 'За неделю', context.watch<LocaleProvider>().t('dashboard.time_month') ?? 'За месяц'];
