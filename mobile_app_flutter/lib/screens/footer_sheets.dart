            ...
            children: [
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Icon(LucideIcons.x, color: colors.foreground.withValues(alpha: 0.5)),
                ),
              ),
              ...
              Text(
                ...
                style: GoogleFonts.inter(fontSize: 14, color: colors.foreground.withValues(alpha: 0.7)),
              ),
            ...
            children: [
              ...
              Flexible(
                child: SingleChildScrollView(
                  child: RichText(
                    text: TextSpan(
                      style: GoogleFonts.inter(fontSize: 14, color: colors.foreground.withValues(alpha: 0.7), height: 1.5),
                      children: textSpans,
                    ),
                  ),
                ),
